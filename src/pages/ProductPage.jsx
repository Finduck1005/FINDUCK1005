      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <nav className="mb-6">
          <div className={`text-sm ${getSecondaryTextClasses()}`}>
            <span>Home</span> &gt;{" "}
            <span>{productDetails.specifications.Category}</span> &gt;{" "}
            <span>{productDetails.specifications.IP}</span> &gt;{" "}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <button
                  onClick={() =>
                    setSelectedImageIndex(
                      Math.min(productImages.length - 1, selectedImageIndex + 1)
                    )
                  }
          ...
          <div className="space-y-6">
            <div>
              <h1
                className={`text-2xl sm:text-3xl font-bold ${getTextClasses()} mb-2`}
              >
                {productDetails.name}
              </h1>
              <div className="flex items-center space-x-4 mb-4">
                <span className={`text-sm ${getSecondaryTextClasses()}`}>
                  Item #{productDetails.itemNumber}
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Link
                to="/create-seller"
                className="w-full bg-green-500 text-white text-center font-bold py-3 rounded-lg hover:bg-green-600 transition-colors"
              >
                Seller Posting
              </Link>
              <Link
                to="/create-buyer"
                className="w-full bg-blue-500 text-white text-center font-bold py-3 rounded-lg hover:bg-blue-600 transition-colors"
              >
                Buyer Posting
              </Link>
            </div>
        ...
        <div className={`${getCardClasses()} rounded-lg p-6 mb-8`}>
          <h3 className={`text-xl font-semibold ${getTextClasses()} mb-4`}>
            Description
          </h3>
          <div className="relative">
            <div
        ...
        <div className={`${getCardClasses()} rounded-lg p-6 mb-8`}>
          ...
          {productDetails.issues && productDetails.issues.length > 0 ? (
              ...
              {productDetails.issues
                ...
                .map((issue, index) => (
                  ...
                  >
                    ...
                    <h4 className={`font-semibold ${getTextClasses()} mb-2`}>
                      {issue.title}
                    </h4>
                    <p
                      className={`text-sm ${getSecondaryTextClasses()} mb-3 leading-relaxed`}
                    >
                      {issue.description}
                    </p>
                    ...
                    {issue.affectedBatches && (
                      <div className="mb-3">
                        <span
                          className={`text-xs font-medium ${getTextClasses()}`}
                        >
                          Affected Batches:{" "}
                        </span>
                        <span
                    ...
                    {issue.workaround && (
                      ...
                      >
                        <span
                          className={`text-xs font-medium ${getTextClasses()} block mb-1`}
                        >
                          Workaround:
                        </span>
                        <span
                    ...
                    <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-200 dark:border-gray-600">
                      <span className={`text-xs ${getSecondaryTextClasses()}`}>
                        {issue.reportsCount} reports • Last updated:{" "}
                        {issue.lastUpdated}
                      </span>
            ...
            <div className={`text-center py-8 ${getSecondaryTextClasses()}`}>
              ...
              <p className="text-sm">
                No known issues reported for this product.
              </p>
              <p className="text-xs mt-1">
                Issues are verified by our community and official sources.
              </p>
            </div>
          )}
          ...
          <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-600">
            <div className="flex items-center justify-between">
              <span className={`text-sm ${getSecondaryTextClasses()}`}>
                Found an issue with this product?
              </span>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <div
                            className={`text-base font-bold ${getTextClasses()} mt-1`}
                          >
                            {row.price}
                          </div>
                        </div>
              ...
              {marketActivity.buying.map((item) => (
                ...
                >
                  <div>
                    ...
                    <p
                      className={`text-sm ${getSecondaryTextClasses()} mb-3 line-clamp-3`}
                    >
                      {item.description}
                    </p>
                  </div>
                  <div>
                    ...
                    <span
                      className={`text-xs ${getSecondaryTextClasses()} mt-2 block`}
                    >
                      📍 {item.location}
                    </span>
                  </div>
        ...
        <div className={`${getCardClasses()} rounded-lg p-6 mb-8`}>
          ...
          <div className="mt-4 text-center">
            <p className={`text-sm ${getSecondaryTextClasses()}`}>
              ...
              <span className={`font-semibold ${getTextClasses()}`}>$335</span>
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {similarProducts.map((item) => (
              <div key={item.id} className="group cursor-pointer">
                ...
                <h4
                  className={`font-medium ${getTextClasses()} text-sm mb-1 line-clamp-2`}
                >
                  {item.name}
                </h4>
                <div className="flex items-center space-x-1">
