  ...
  export default function Component() {
    ...
    // 테마 상태 저장 (normal, dark, desk), 기본 normal
      ...
      >
        ...
        <header className="w-full py-6 px-4">
          <div className="max-w-7xl mx-auto flex justify-between items-center relative">
            <Link 
              to="/"
              className={`text-2xl font-bold ${getTextClasses()}`}>
              FINDUCK
            </Link>
            ...
            <div className="flex items-center space-x-4">
              {/* isLoggedIn 값에 따라서 카카오 로그인, 로그아웃 설정 */}
              {isLoggedIn ? (
                <div className="flex items-center gap-3 max-w-[200px]">
                  {/* 로그인한 상태라면, 기본 이미지와 설정된 닉네임을 가져와서 표시 */}
                  <img
                    src={`https://ui-avatars.com/api/?name=${encodeURIComponent(userInfo.nickname)}&background=0D8ABC&color=fff`}
                    alt="프로필"
              ...
              <div className="flex bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
                <button
                  ...
                  className={`p-2 rounded-md transition-colors ${theme === "normal" ? "bg-white shadow-sm text-blue-600" : "text-gray-600 hover:text-gray-800"}`}
                  title="Normal Mode"
                >
                ...
                <button
                  ...
                  className={`p-2 rounded-md transition-colors ${theme === "dark" ? "bg-gray-600 shadow-sm text-yellow-400" : "text-gray-600 hover:text-gray-800"}`}
                  title="Dark Mode"
                >
                ...
                <button
                  ...
                  className={`p-2 rounded-md transition-colors ${theme === "desk" ? "bg-blue-100 shadow-sm text-blue-600" : "text-gray-600 hover:text-gray-800"}`}
                  title="Desk Mode"
                >
        ...
        >
          ...
          <div className="max-w-7xl mx-auto mt-8 pt-8 border-t border-slate-700 text-center text-slate-300">
            <p>&copy; 2025 FINDUCK. All rights reserved.</p>
          </div>
        </footer>
      </div>
    );
