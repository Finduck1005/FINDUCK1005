...
import { Moon, Sun, Monitor, Upload, X, ChevronDown, DollarSign, AlertCircle, Eye, Save, Send } from "lucide-react"
...
export default function CreateSellerPost() {
  ...
  const conditions = ["New with box", "New without box", "Used - Excellent", "Used - Good", "Used - Fair"]
  const sizes = [
    "US 6",
    "US 6.5",
    "US 7",
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${getThemeClasses()}`}>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        {/* 페이지 헤더 */}
        <div className="mb-8">
          <h1 className={`text-3xl font-bold ${getTextClasses()} mb-2`}>Create New Listing</h1>
          <p className={`${getSecondaryTextClasses()}`}>
            Fill out the details below to create your listing. All fields marked with * are required.
          </p>
        </div>
        ...
        <form className="space-y-8">
          ...
          <div className={`${getCardClasses()} rounded-lg p-6`}>
            <h2 className={`text-xl font-semibold ${getTextClasses()} mb-4`}>Photos *</h2>
          ...
          {/* 기본 정보 */}
          <div className={`${getCardClasses()} rounded-lg p-6`}>
            <h2 className={`text-xl font-semibold ${getTextClasses()} mb-4`}>Basic Information</h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* 제목 */}
              <div className="md:col-span-2">
                <label className={`block text-sm font-medium ${getTextClasses()} mb-2`}>Title *</label>
                <input
                  type="text"
              ...
              {/* 사이즈 */}
              <div>
                <label className={`block text-sm font-medium ${getTextClasses()} mb-2`}>Size *</label>
                <div className="relative">
                  <select
                    value={formData.size}
              ...
              {/* 상태 */}
              <div>
                <label className={`block text-sm font-medium ${getTextClasses()} mb-2`}>Condition *</label>
                <div className="relative">
                  <select
              ...
              {/* 색상 */}
              <div>
                <label className={`block text-sm font-medium ${getTextClasses()} mb-2`}>Color</label>
                <input
                  type="text"
          ...
          <div className={`${getCardClasses()} rounded-lg p-6`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className={`block text-sm font-medium ${getTextClasses()} mb-2`}>Price *</label>
                <div className="relative">
          ...
          <div className={`${getCardClasses()} rounded-lg p-6`}>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
              <p className={`${getSecondaryTextClasses()}`}>
                Your listing preview will appear here once you fill out the required fields
              </p>
            </div>
          </div>
          ...
          <div className={`${getCardClasses()} rounded-lg p-6 border-l-4 border-blue-500`}>
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className={`font-semibold ${getTextClasses()} mb-2`}>Tips for a successful listing:</h3>
                <ul className={`text-sm ${getSecondaryTextClasses()} space-y-1`}>
                  ...
                  <li>• Include original box, receipts, or authenticity proof when available</li>
