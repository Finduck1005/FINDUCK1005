      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="text-xl sm:text-2xl font-bold text-gray-800">ShopHub</div>
          ...
          {/* Mobile Navigation */}
          {isMobileMenuOpen && (
            <div id="mobile-nav" className="md:hidden border-t border-gray-200 py-4">
              <nav className="flex flex-col space-y-4" aria-label="Primary mobile">
                <a href="#" className="text-gray-600 hover:text-gray-800 transition-colors px-2">
                  Home
                </a>
                <a href="#" className="text-gray-600 hover:text-gray-800 transition-colors px-2">
                  Shop
                </a>
                <a href="#" className="text-blue-600 font-medium px-2">
                  My Page
                </a>
                <a href="#" className="text-gray-600 hover:text-gray-800 transition-colors px-2">
                  Orders
            ...
            <section className="bg-white rounded-2xl shadow-sm p-4 sm:p-6 mb-6">
              <div className="text-center">
                <div className="relative inline-block">
                  <img
                    src={userProfile.profileImage || "/placeholder.svg?height=120&width=120&query=profile-avatar"}
                    alt="Profile avatar"
                    width={120}
                    height={120}
                ...
                <p className="text-sm sm:text-base text-gray-600 mb-3">{userProfile.fullName}</p>
                <p className="text-xs sm:text-sm text-gray-500 mb-4 px-2">{userProfile.bio}</p>
                <p className="text-xs sm:text-sm text-gray-500 mb-4 px-2">{userProfile.link}</p>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 sm:mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Selling: {mySellingPosts.length} • Buying: {myBuyingPosts.length}
                  </p>
                </div>
                  ...
                  <div className="flex bg-gray-100 rounded-lg p-1">
                    <button
                      className={`px-3 sm:px-4 py-1.5 rounded-md text-sm font-medium transition-colors ${
                        activeTab === "selling" ? "bg-white shadow-sm text-blue-600" : "text-gray-600"
                      }`}
                    ...
                    <button
                      className={`px-3 sm:px-4 py-1.5 rounded-md text-sm font-medium transition-colors ${
                        activeTab === "buying" ? "bg-white shadow-sm text-blue-600" : "text-gray-600"
                      }`}
              ...
              {activeTab === "selling" ? (
                mySellingPosts.length > 0 ? (
                    ...
                    {mySellingPosts.map((item) => (
                      ...
                      >
                        <div className="relative mb-3 sm:mb-4">
                          <img
                            src={item.image || "/placeholder.svg?height=220&width=320&query=item-image"}
                            alt={item.name}
                            width={320}
                            height={220}
                  ...
                  <div className="text-center py-12 text-gray-600">
                    <p className="mb-2">You haven't posted any items for sale yet.</p>
                    <a
                      href="/sell/create"
                    ...
                    >
                      ...
                      <div className="space-y-1 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-gray-800">{post.sizeWanted}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-500">Condition:</span>
                          <span className="font-medium text-gray-800">{post.conditionPreference}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-500">Max Budget:</span>
                          <span className="font-medium text-gray-800">{post.maxBudget}</span>
                        </div>
                      </div>
